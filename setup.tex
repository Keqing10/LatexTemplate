...
% 在\array中使用横虚线\hdashline
\usepackage{arydshln}

% 自定义命令
\newcommand{\md}{\mathrm{d}}  % 微分算符d，也可以使用\dif 
...
\newcommand{\uppartial}{\allmodesymb{\greeksym}{\char"B6}} % partial符号
\newcommand{\mpp}[2]{\frac{\uppartial #1}{\uppartial #2}} % 分数形式的偏导数
